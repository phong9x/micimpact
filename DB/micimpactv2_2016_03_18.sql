...
INSERT INTO `cards` (`id`, `user_id`, `category_id`, `thumbnail_url`, `target_url`, `title`, `body`, `type`, `count_like`, `share`, `runing_time`, `created_at`, `ad_is`, `ad_ment`, `ad_link`, `related_card_id`, `hit_count`, `comment_count`, `actor`, `actor_job`, `vertical_thumbnail_url`, `channel_id`) VALUES
	...
	(3, 1, 1, 'thumbnail/cc.jpg', NULL, '???? ???? ?? ?', '?? ?? ??? ? ???', 2, 1, 8, NULL, '2016-01-04 15:00:00', 0, NULL, NULL, NULL, 1583, 16, '???', '????', 'vertical_thumbnail/a8dab35d-1045-46ca-93bd-0a9af8a6b261.jpg', NULL),
	(4, 1, 3, 'thumbnail/cf578cf5-ca80-43be-be71-4974bd4ebe08.jpg', NULL, '??? ???? ? ??? ? ??', '“?? ? ??? ?? ??? ?? ??? ??? ???, ?? ?? ????? ??? ???? ???? ????”', 2, 4, 3, NULL, '2016-01-11 01:40:52', 0, NULL, NULL, NULL, 1228, 4, '???', '???', 'vertical_thumbnail/c54900a4-101d-46a3-b43d-8bb481652fc4.png', NULL),
	(5, 1, 2, 'thumbnail/18ddcd0e-1e9a-47c9-a299-71fc9105285f.jpg', NULL, '???? ??? ???? ??', '"???? ?? ??? ??? ???? ???? ???? ?? ???? ?? ?? ? ???."', 2, 1, 1, NULL, '2016-01-11 01:40:52', 0, NULL, NULL, NULL, 529, 3, '???', '???', 'vertical_thumbnail/1f68d83d-570f-4180-ac5f-b395cdd4078a.jpg', NULL),
	(6, 1, 1, 'thumbnail/e6270ac0-e969-40e1-a760-df619e7c223b.png', NULL, '??? ??', '“??? ???? ? ?? ?? ? ??? ?? ?? ? ??? ? ?? ?? ???, ?? ?? ? ?? ???? ???, ?? ???? ????? ?? ??? ???”', 2, 3, 4, NULL, '2016-01-11 01:41:28', 0, NULL, NULL, NULL, 422, 1, '???', '???', 'vertical_thumbnail/005b7884-0310-4662-8f1f-c35a98f4385f.png', NULL),
	(7, 1, 1, 'thumbnail/12829f20-c425-4d1f-9620-d61093a94579.jpg', NULL, '??? ?? ?? ??? ?? ?? ???? ??', '"??? ???? ???? ??? ?? ??? ???? ???."', 2, 0, 1, NULL, '2016-01-11 07:53:36', 0, '?????? ???? ? ??? ??? ?????!', 'http://micimpact.com/', 0, 338, 1, '?? ? ??', '???', 'vertical_thumbnail/a77671ff-f8fc-4e0a-a448-fff88141f413.jpg', NULL),
	...
	(26, 1, 1, NULL, NULL, '?? ??? ?? ??? ???', 'The World Changing Story ??? ??? ??? ?????? Copyright?2016 By MICIMPACT. All right reserved.', 2, 0, 0, NULL, '2016-01-18 07:17:35', 1, '??? ??? ??? : ? ??? 2016', 'http://www.grandmasterclass.com/2016/index.php', NULL, 359, 0, '???', '???', 'vertical_thumbnail/3b31418d-0d5f-4d3e-8d5e-c77907593076.png', NULL),
	(27, 1, 1, 'thumbnail/6c845465-4692-4037-b91c-02a91765cee1.mp4_000027977', 'stream_output/b14ac1d8-2505-4d9b-b07e-071a0ad963ea/d417f35dc2a9758505c0039a5f7c03fb37ef23dc89051d90c118f0a03aabcc33.m3u8', '?? ???? ??? ? ??? ?? ????', '?????? 2015', 0, 1, 5, NULL, '2016-01-18 08:55:54', 0, NULL, NULL, NULL, 460, 32, '???', '??', NULL, NULL),
...
-- Dumping data for table micimpact.channel: ~3 rows (approximately)
DELETE FROM `channel`;
...
INSERT INTO `channel` (`id`, `user_id`, `title`, `introduce`, `likes`, `favorite`, `is_show`, `type`, `created_at`, `cards_recent_id`) VALUES
	...
	(26, 133, 'Test1', 'Test123', 0, 0, 1, 0, NULL, NULL);
...
-- Dumping data for table micimpact.comments: ~39 rows (approximately)
...
INSERT INTO `comments` (`id`, `card_id`, `user_id`, `body`, `created_at`, `count_like`) VALUES
	...
	(48, 27, 133, 'Asdasdasd', '2016-03-18 11:17:58', 0),
	(49, 27, 133, 'Cxcxc', '2016-03-18 11:18:41', 0),
	(50, 27, 133, 'Xzxzx', '2016-03-18 11:21:44', 0),
	(51, 6, 133, 'Xzcxzc', '2016-03-18 11:27:01', 0);
...
INSERT INTO `users` (`id`, `role_id`, `password`, `name`, `email`, `created_at`, `updated_at`, `fag`, `facebook_token`, `kakaotalk_token`, `line_token`, `birthyear`, `sex`, `job`, `city`, `activity_point`, `level`, `point`, `push_state`, `profile_url`, `is_withdrawn`, `heart_state_id`, `recent_card_id`) VALUES
	...
	(133, 2, '', 'Sao V?', 'ptit.cn8.star@gmail.com', '2016-03-07 09:07:33', '2016-03-07 09:07:33', 1, '637781699695960', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 27),
