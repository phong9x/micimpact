...
-- Dumping data for table micimpact.cards: ~55 rows (approximately)
DELETE FROM `cards`;
...
-- Dumping data for table micimpact.card_tags: ~104 rows (approximately)
...
-- Dumping data for table micimpact.images: ~289 rows (approximately)
DELETE FROM `images`;
...
INSERT INTO `users` (`id`, `role_id`, `password`, `name`, `email`, `created_at`, `updated_at`, `fag`, `facebook_token`, `kakaotalk_token`, `line_token`, `birthyear`, `sex`, `job`, `city`, `activity_point`, `level`, `point`, `push_state`, `profile_url`, `is_withdrawn`, `heart_state_id`, `recent_card_id`) VALUES
	...
	(136, 2, '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', 'huydv0109', 'huydv0109@gmail.com', '2016-03-08 03:53:45', '2016-03-08 03:53:45', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile/5534e268-64e8-4612-82a7-8653f7d5447a.jpg', NULL, 1, 60),
