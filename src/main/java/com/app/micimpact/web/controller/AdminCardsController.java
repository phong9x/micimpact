 ...
 */
@Controller
@RequestMapping("/admin/manage_cards")
public class AdminCardsController extends AbstractController {
	...
	private static final String JSP_LIST   = "admin/manage_cards";
	private static final String JSP_POPUP_SEARCH_CARD	= "admin/search_popup/popup_cards_list";

	//--- SAVE ACTION ( in the HTML form )
	private static final String SAVE_ACTION_CREATE   = "/admin/manage_cards/create";
	private static final String SAVE_ACTION_UPDATE   = "/admin/manage_cards/update";

	private static final String CARDS_DETAIL_URL   = "/admin/manage_cards/form";
	 ...
	 * Default constructor
	 */
	public AdminCardsController() {
		super(AdminCardsController.class, MAIN_ENTITY_NAME );
	...
	public String list(Model model,
		...
		if(keyword == null || option==0){
			keyword="";
		}
		Page<CardsEntity> list;
		if(option==2){
			list = cardsService.findAllOrder(pageNumber,"%%","%"+keyword+"%", sort);
		}else {
			list = cardsService.findAllOrder(pageNumber,"%"+keyword+"%","%%", sort);
		}
		
		String path = "/admin/manage_cards";
		model.addAttribute("sort", sort);
		model.addAttribute("option", option);
		model.addAttribute("keyword", keyword);
		model.addAttribute("param_url", "option="+option+"&amp;keyword="+keyword+"&amp;sort="+sort);
	...
	public HashMap<String, Object> create(
		...
		cards.setCreatedAt(new Date());
			...
			if (imgVerticalThumbnail != null)
			{
				...
				String verticalThumbnailUrl = uploadS3(thumbnail_path, imgVerticalThumbnail, extension[1]);
				if (verticalThumbnailUrl==null)
					return FAIL(ret, "첫 이미지 업로드에 실패하였습니다.");

				cards.setVerticalThumbnailUrl(verticalThumbnailUrl);
			}
			...
			if(cards.getType()==1){
				...
				if (imgThumbnail != null)
				{
					...
					cards.setThumbnailUrl(thumbnailUrl);
				}
			}
		...
		if(createdCard !=null){
			ret.put("url", CARDS_DETAIL_URL+"/"+createdCard.getId());
			ret.put("cardId", createdCard.getId());
			return SUCCESS(ret);
		}else {
...
//	}
	...
	public HashMap<String, Object> update(
		...
		updatedCard.setCategoryId(cards.getCategoryId());
...
//			method= RequestMethod.POST,
//			produces="text/plain;charset=UTF-8") // GET or POST
...
//	}
	...
	public String delete(RedirectAttributes redirectAttributes, @PathVariable("id") Integer id) {
		...
		return "redirect:/admin/manage_cards";
	}
...
//			if (result)
	...
	public String popupSearchCard(Model model,
		...
		String path = "/admin/manage_cards/popup_search_card/"+type;
		new Pager<CardsEntity>(list, model).pageSetting(path);
