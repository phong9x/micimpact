	...
	<div class="container">
		<fieldset class="col-sm-12 bordure">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						<th><s:message code="images.id"/></th>
						<th><s:message code="images.cardId"/></th>
						<th><s:message code="images.imageUrl"/></th>
						<s:url var="url_create" value="/images/form"  />
				...
				<tbody>
					<c:forEach items="${list}" var="images">
						<tr>
							...
							<s:url var="url_update" value="/images/form/${images.id}"/>
