	...
	<div class="container">
		<fieldset class="col-sm-12 bordure">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						<th><s:message code="intialTags.name"/></th>
						<s:url var="url_create" value="/intialTags/form"  />
						<th><a class="btn btn-info" href='${url_create}'><s:message code="create"/></a></th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${list}" var="intialTags">
						<tr>
							<td>${intialTags.name}</td>
							<s:url var="url_update" value="/intialTags/form/no_primary_key_for_entity_IntialTags"/>
